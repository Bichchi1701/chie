...
//    public ArrayList<room> showAvailableRoom(String day, String type){
//    	 ArrayList<room> list = new ArrayList<>();
//         try{
//             // Lấy ra đối tượng Connection kết nối vào DB.
//        	 connection = getConnection();          
...
//                 String dateIn = rs.getString(4);
//                 String dateOut = rs.getString(5);
//                 String sql2="Select * from rooms where type='"+type+"' and id NOT IN (Select idRoom from book where dateIn <= '"+day+"' and dateOut >= '"+day+"');";
//                 rs2 = ptmt.executeQuery(sql2);
//                 while(rs2.next()){
//                     int idR = rs2.getInt(1);
//                     String numRoom = rs2.getString(2);
//                     int price = rs2.getInt(3);
//                     String typeF = rs2.getString(4);
//                     int status = rs2.getInt(5);
//                     room room1 = new room(idR, numRoom, price, typeF, status);
//                     list.add(room1);	
//                 }
//                 hasRs= ptmt.getMoreResults();
//             }
//         }catch(Exception e){}
//         return list;
//    }
    public ArrayList<room> showAvailableRoom(String day, String type){
   	 ArrayList<room> list = new ArrayList<>();
        try{
        	  String sql="Select * from rooms where type='"+type+"' and id NOT IN (Select idRoom from book where dateIn <= '"+day+"' and dateOut >= '"+day+"');";
            // Lấy ra đối tượng Connection kết nối vào DB.
       	 	connection = getConnection();          
            Scanner keyboard = new Scanner(System.in);           
            SimpleDateFormat formatter=new SimpleDateFormat("yyyy-MM-dd");  
